        ...
        <div class="col-md-12 ml-auto mr-auto">
            ...
            <div class="card mt-3 mb-3">
              <div class="card-body">
                ...
                <form class="mt-5" action="{{ url('admin/campaign/store/'.$campaign_tree->id) }}" method="POST">
                    @csrf
                    <div class="mb-3 col-md-6 ml-auto mr-auto">
                        <label for="campaign_name" class="form-label">Campaign Name</label>
                        <input type="text" class="form-control" id="campaign_name" name="campaign_name" value="" required>
                    </div>
                    <div class="mb-3 col-md-6 ml-auto mr-auto">
                        <label for="campaign_description" class="form-label">Campaign Description</label>
                        <textarea class="form-control" id="campaign_description" name="campaign_description" required></textarea>
                    </div>
                    ...
                    <div class="mb-3 col-md-6 ml-auto mr-auto before_hours hidden">
                        <label for="before_hours" class="form-label">Before Hours</label>
                        <input type="number" class="form-control" id="before_hours" name="before_hours" value="">
                    </div>
    ...
    <div class="message-container">
        <div class="card">
            ...
            <div class="card-body text-left">
                <div class="mb-3">
                    <input type="hidden" class="msg_index" name="msg_index[]" value="0">
                    <div>
    ...
    $(document).ready(function() {
        ...
        $(".container").on('change', '.w-d, .w-m', function(){
            ...
            if ($(this).val() == "minute") {
                ...
                parent.find(".days").val("");
                parent.find(".delivery_time").val("");
            } else {
