    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" id="campaign-tree-tab" href="{{ url('/admin/custom_fields/campaign_tree') }}">Campaign Tree</a>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="mt-4">
                        <form class="mt-5" action="{{ url('/admin/custom_fields/campaign_tree') }}" method="GET">
                            <div class="row mb-3">
                                <div class="col-md-3">
                        ...
                        @if (isset($campaign_category) && isset($campaign_tree) && isset($data_fields))
                            <h5 class="mt-3">Selected Campaign Category: {{$campaign_category->name}} <i class="fa fa-long-arrow-right"></i> {{$campaign_tree->name}}</h5>
                            <div class="text-right mb-3">
                                <a href="#" class="btn btn-primary add_custom_field pl-4 pr-4" data-toggle="modal" data-target="#appModal" data-id="{{$campaign_category_id}}" data-treeid="{{$campaign_tree_id}}"><i class="fa fa-plus"></i> Add New Custom Field</a>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $(".add_custom_field").click(function(e) {
            var id = $(this).data('id');
            var tree_id = $(this).data('treeid');
            $.ajax({
                url: base_url+"/admin/custom_fields/campaign_tree/add/"+id+"/"+tree_id,
                cache: false,
                type: "GET",
                data: {},
                beforeSend: function() {
        ...
        $(".edit_custom_field").click(function(e) {
            var id = $(this).data('id');
            $.ajax({
                url: base_url+"/admin/custom_fields/campaign_tree/edit/"+id,
                cache: false,
                type: "GET",
                data: {},
                beforeSend: function() {
